...
<div id="home" class="header">               <!--应用header的div-->
  ...
  <div class="container"> 
 	              ...
 	              <img src="picture/light2.jpg" width="400" height="500" /></div>
				 	<div class="col-md-7 ab-text">
                    <p>Votoro promise the best experience of using our Light!</p>
              <p>the size:160mm*150mm*310mm</p>
				<p>Type: the flod light</p>
				<p>Electric power:10W</p>
                <p>Voltage:220V
                <p>Frequency:45-60w</p>
                <p> <em><strong>If you want to buy one, please click the shopping car below.</strong></em><strong></strong>!!!!</p>
                <a href="./addGood?goodname=votoro"><img src="picture/shoppingCar.jpg" width="50" height="50" /></a> 
                </div>
