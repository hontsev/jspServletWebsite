...
<div id="home" class="header">               <!--应用header的div-->
  ...
  <div class="container"> 
	 	           ...
	 	           <img src="picture/light1.jpg" width="400" height="500" /></div>
				 	<div class="col-md-7 ab-text">
                    <p>Philips has a great reputation in making electrinic products. Our brand name would promise the perfromance of this light.</p>
                <p>the size:333mm*201mm*201mm</p>
				<p>Type: the table light</p>
				<p>Electric power:11W</p>
                <p>Voltage:220V
                <p>Frequency:50-60w</p>
                <p> <em><strong>If you want to buy one, please click the shopping car below.</strong></em><strong></strong>!!!!</p>
                <a href="./addGood?goodname=philips"><img src="picture/shoppingCar.jpg" width="50" height="50" /></a> 
                </div>
