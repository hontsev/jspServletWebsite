...
public class ShoppinghistoryServlet extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		Good[] goods = dao.getUserShoppinghistory(user);
		...
		out.println("<h3>ShoppingHistory</h3></br></hr>");
		if(goods != null){
			out.println("</br></hr><table border='1'><tr><th>No</th><th>ProductName</th><th>UserAddress</th><th>Date of Purchase</th></tr>");
			for(int i=0;i<goods.length;i++){
				if(goods[i]!=null){
					...
					out.println("<td>"+goods[i].getTime()+"</td>");
					out.println("</tr>");
				}
			}
			out.println("</table>");
